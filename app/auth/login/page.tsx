    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-background to-accent/5 px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground">Liver Disease Prediction & Doctor Booking</p>
        </div>

        <Card className="border-border/50 shadow-lg">
          <CardHeader>
            <CardTitle>Welcome Back</CardTitle>
            <CardDescription>Sign in to access your health assessment and book appointments</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-6 text-center text-xs text-muted-foreground">
          <p>© 2026 LiverCare. Secure healthcare at your fingertips.</p>
        </div>
      </div>
    </div>
  );
